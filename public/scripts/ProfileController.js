 angular.module('bikeApp').controller('ProfileController', function($http, $location, $rootScope, geolocation, gservice){
...
$http.post('/profile', bikeRoute).success(function(data){
